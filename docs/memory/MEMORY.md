...
- [Picks Tab](picks_tab.md) — gijun42.com Picks tab (US 15 / US+Korea 15 vs frozen 2026-09-18 closes, web/src/lib/picks.ts); Yahoo daily chart last bar can be null → "today" price is really yesterday, check the bar date
- [Job Application Profile](job_application_profile.md) — personal details for application forms (name, phone, address, UCB applied math 2026-06→2028-05 GPA 3.7, SMC math AA GPA 4.0, he/him); Claude fills, USER attaches resume + ticks attestations + clicks Submit
- [Source Hierarchy + Agent Standard](feedback_source_hierarchy.md) — transcripts read fully (mgmt only); no transcript = company IR releases/filings only; articles = pointers; enrich agents Opus high (subagent_type enricher); script checks every batch, Opus verifier batched ~5 jobs
- [Semis Expansion 2026-09-25](semis_expansion_2026_09_25.md) — +133 knowledge-built skeleton nodes (user-ordered, 5 Opus verifiers), YJ Semi→Yuanjie, first minerals layer, logos; revert-by-name note; 17 leftover candidates
